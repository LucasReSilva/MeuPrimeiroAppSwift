...
class PrimeiraTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.musicas = MusicaDOA.getMusicas()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        if let musicaCell = cell as? PrimeiraTableViewCell{
            
            let musica = self.musicas[indexPath.row]
            
            musicaCell.titulo.text = musica.titulo
            musicaCell.autor.text = musica.artista
        }
